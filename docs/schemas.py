...
FormSchema = Model(
    "Form",
    {
        ...
        "questions": fields.List(
            fields.Nested("Question"), description="Questions du formulaire"
        ),
    },
)

# Schéma pour créer un formulaire
FormCreateSchema = Model(
    "FormCreate",
    {
        "title": fields.String(
            required=True,
            description="Titre du formulaire",
            example="Sondage de satisfaction",
        ),
        "description": fields.String(
            description="Description du formulaire", example="Évaluez notre service"
        ),
        "settings": fields.Raw(
            description="Paramètres du formulaire",
            example={"theme": "blue", "public": True},
        ),
    },
)
...
QuestionSchema = Model(
    "Question",
    {
        ...
        "options": fields.List(
            fields.String, description="Options pour les questions à choix"
        ),
...
ResponseCreateSchema = Model(
    "ResponseCreate",
    {
        "answers": fields.Raw(
            required=True,
            description="Réponses aux questions (JSON)",
            example={
                "question_id_1": "Ma réponse",
...
SuccessSchema = Model(
    "Success",
    {
        ...
        "message": fields.String(
            description="Message de confirmation", example="Opération réussie"
        ),
...
ErrorSchema = Model(
    ...
    {
        "error": fields.String(
            description="Message d'erreur", example="Erreur de validation"
        ),
...
HealthSchema = Model(
    "Health",
    {
        ...
        "message": fields.String(
            description="Message de statut", example="FormForge POC Backend is running"
        ),
