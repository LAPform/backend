...
def test_validation_forms():
    ...
    response = requests.post(
        f"{api_url}/api/forms",
        json={"title": "A" * 300, "description": "Test description"},  # Titre trop long
        headers=headers,
    )
    print(f"Status: {response.status_code}")
    print(f"Response: {response.json()}")
...
def test_validation_questions():
    ...
    response = requests.post(
        f"{api_url}/api/forms",
        json={"title": "Test Form", "description": "Test description"},
        headers=headers,
    )
    ...
    response = requests.post(
        ...
        json={"type": "invalid_type", "text": "Test question", "required": True},
        headers=headers,
    )
    print(f"Status: {response.status_code}")
    print(f"Response: {response.json()}")
    ...
    response = requests.post(
        f"{api_url}/api/forms/{form_id}/questions",
        json={"type": "text", "text": "A" * 600, "required": True},  # Texte trop long
        headers=headers,
    )
    print(f"Status: {response.status_code}")
    print(f"Response: {response.json()}")
...
if __name__ == "__main__":
    print("Tests de Validation des Donnees")
    print("=" * 60)
