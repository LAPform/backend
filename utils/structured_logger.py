...
class APILogger:
    ...
    def user_registered(self, user_id: str, email: str):
        ...
        self.logger.info(
            "User Registered", user_id=user_id, email=email, action="user_registration"
        )
    ...
    def question_created(
        self, question_id: str, form_id: str, user_id: str, question_type: str
    ):
    ...
    def database_operation(
        self, operation: str, table: str, duration_ms: float, success: bool
    ):
...
class DatabaseLogger:
    ...
    def query_executed(
        self, query_type: str, table: str, duration_ms: float, rows_affected: int = None
    ):
    ...
    def query_failed(
        self, query_type: str, table: str, error: str, exception: Exception = None
    ):
