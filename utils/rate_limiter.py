...
class RateLimiter:
    ...
    def __init__(self):
        ...
        self.limits = {
            ...
            'files_upload': {'requests': 10, 'window': 3600},   # 10 req/h
            'files_download': {'requests': 50, 'window': 3600}, # 50 req/h
    ...
    def is_allowed(self, route_name: str) -> Tuple[bool, Dict]:
        ...
        try:
            ...
            return True, {'limit': 100, 'remaining': 99, 'reset_time': time.time() + 3600}
